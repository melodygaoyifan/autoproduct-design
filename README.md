...
[implementation map](https://github.com/melodygaoyifan/ai-venture-studio/blob/main/docs/implementation-map.md)
...
that bounds it:
[ADR-029](https://github.com/melodygaoyifan/ai-venture-studio/blob/main/docs/adr/029-mcp-transport-partial.md)
(MCP is the real subprocess transport for the tool surface, superseding the
"in-process by mapping" compromise),
[ADR-030](https://github.com/melodygaoyifan/ai-venture-studio/blob/main/docs/adr/030-multi-tenant-server.md)
(multi-tenant server, not SaaS), and
[ADR-031](https://github.com/melodygaoyifan/ai-venture-studio/blob/main/docs/adr/031-policy-armed-automation.md)
