...
| k6 as the CI-gating default (in-script thresholds, non-zero exit); Locust as Python-ecosystem alternate with built-in distribution; wrk2/autocannon micro-bench; ghz/fortio for gRPC/WS | [QAInsights 2026](https://qainsights.com/jmeter-vs-k6-vs-locust-in-2026-which-load-testing-tool-should-you-pick/); [QASkills](https://qaskills.sh/blog/k6-vs-locust-2026); [tools deep-dive 2026](https://www.youngju.dev/blog/culture/2026-05-14-load-testing-tools-2026-k6-locust-vegeta-gatling-artillery-jmeter-comparison-deep-dive.en) | §77.2 slot design |
| Load-test validity: generator saturation (CPU<80%, dropped_iterations), measurement path = user path, arrival model (open/closed), soak 4–8h for slow-burn defects, SLO as p50/p95/p99 + error budget | [k6 practice guide](https://beefed.ai/en/api-load-testing-k6-guide); [ARDURA 2026](https://ardura.consulting/blog/load-testing-complete-guide-2026/) | §77.3 ADR-U30 preconditions; §77.4 |
| Netcode model selection (lockstep/rollback/server-authoritative/relay) and determinism leak sources (float, RNG, iteration order, trig, wall-clock) | [mas-bandwidth](https://mas-bandwidth.com/choosing-the-right-network-model-for-your-multiplayer-game/); [Easel docs](https://easel.games/docs/learn/multiplayer/rollback-netcode) | §79.1–79.2 |
| Deterministic replay of recorded inputs + exact-timing network-event mocks as the netcode test primitive | [DelayNoMoreUnity](https://github.com/genxium/DelayNoMoreUnity) | §79.3 replay-identity fixtures |
| Schema-registry defaults disagree (Confluent BACKWARD, Glue DISABLED, Apicurio NONE); CI compatibility gating; auto.register.schemas=false; producer-SDK-only enforcement boundary; ODCS/Bitol data contracts; CEL rules + DLQ | [Factor House](https://factorhouse.io/articles/best-practices-kafka-data-observability); [Confluent SR practices](https://www.confluent.io/blog/best-practices-for-confluent-schema-registry/); [Confluent data contracts](https://docs.confluent.io/platform/current/schema-registry/fundamentals/data-contracts.html) | §80.1–80.2 ADR-U32; invariant 14.25 |
| Architecture fitness functions (Ford/Parsons/Kua): import-linter / dependency-cruiser / ArchUnit-Spring-Modulith; run in the agent's verify loop, not only CI; Shopify packs checkpoint pattern (deprecated_references whittled down) | [pattern reference](https://aipatternbook.com/architecture-fitness-function); [dependency-cruiser](https://xebia.com/blog/taking-frontend-architecture-serious-with-dependency-cruiser/); [modular monolith 2026](https://dev.to/x4nent/the-modular-monolith-2026-complete-guide-spring-modulith-archunit-fitness-functions-and-lessons-878) | §81.1 |
| Flag lifecycle: ~80% of removals touch >1 file; LaunchDarkly 6-stage, 90–120d healthy time-to-archive; Unleash "stuck in Cleanup" debt signal; flag categories; combination testing; OpenFeature | [2026 rollout playbook](https://www.digitalapplied.com/blog/feature-flag-rollout-strategies-2026-engineering-playbook); [cleanup checklist](https://www.momentslog.com/development/feature-flag-cleanup-checklist-how-to-prevent-temporary-toggles-from-becoming-production-risk-2); [Zylos 2026](https://zylos.ai/research/2026-02-12-feature-flags) | §82.2 ADR-U35 |
